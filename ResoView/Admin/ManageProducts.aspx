      ...
      <asp:GridView AutoGenerateColumns="False" CssClass="table table-bordered table-striped" DataKeyNames="Id" ID="GridViewProducts" OnRowCancelingEdit="GridViewProducts_RowCancelingEdit" OnRowDeleting="GridViewProducts_RowDeleting" OnRowEditing="GridViewProducts_RowEditing" OnRowUpdating="GridViewProducts_RowUpdating" runat="server">
        <Columns>
          ...
          <asp:TemplateField HeaderText="Actions">
            <ItemTemplate>
              <asp:LinkButton CausesValidation="false" CommandName="Edit" CssClass="btn btn-sm btn-primary" ID="btnEdit" runat="server" Text="Edit" />
              <asp:LinkButton CausesValidation="false" CommandName="Delete" CssClass="btn btn-sm btn-danger" ID="btnDelete" OnClientClick="return confirm('Are you sure you want to delete this product?');" runat="server" Text="Delete" />
            </ItemTemplate>
            <EditItemTemplate>
              <asp:LinkButton CommandName="Update" CssClass="btn btn-sm btn-success" ID="btnUpdate" runat="server" Text="Update" />
              <asp:LinkButton CausesValidation="false" CommandName="Cancel" CssClass="btn btn-sm btn-secondary" ID="btnCancel" runat="server" Text="Cancel" />
            </EditItemTemplate>
          </asp:TemplateField>
        </Columns>
      </asp:GridView>
